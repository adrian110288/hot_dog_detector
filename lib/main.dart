...
class _MyHomePageState extends State<MyHomePage> {
                      ...
                      return Container(
                        child: Center(
                          child: Text(
                            _labels[index].label,
                            style: TextStyle(
                              color: _itsHotDog && _labels[index].label.toLowerCase() == "hot dog" ? Colors.green : Colors.white,
                            ),
                          ),
                        ),
                      );
  ...
  Future _elaborateImage(BuildContext context) async {
    ...
    setState(() {
      ...
      _itsHotDog = labels.where((label) => label.label.toLowerCase() == 'hot dog').isNotEmpty;
      _labels.clear();
